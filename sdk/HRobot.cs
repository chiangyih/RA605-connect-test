...
namespace SDKHrobot {
    ...
    class HRobot {
        ...
        [DllImport( "HRSDK.dll" )]
        public static extern int spline( int robot, int mode, double smooth_value );
        [DllImport( "HRSDK.dll" )]
        public static extern int set_spl( int robot, int coor_type, double[] p );
        [DllImport( "HRSDK.dll" )]
        public static extern int clear_spl( int robot);
        [DllImport( "HRSDK.dll" )]
        ...
        [DllImport( "HRSDK.dll" )]
        public static extern int get_current_ext_rpm( int robot, double[] rpm );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_current_tcp_speed( int robot, double[] speed );
        [DllImport( "HRSDK.dll" )]
